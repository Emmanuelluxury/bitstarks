...
export default function WalletModal({ isOpen, onClose, onConnectWallet, network, showSections, bitcoinNetwork = 'testnet' }: WalletModalProps) {
      ...
      switch (walletType) {
        case 'ready':
          if (typeof window !== 'undefined' && window.starknet_argentX) {
            ...
            let detectedNetwork: 'mainnet' | 'testnet' = 'testnet';
            try {
              ...
              console.warn('Could not detect Ready wallet network, defaulting to testnet:', networkError);
            }
        ...
        case 'braavos':
          if (typeof window !== 'undefined' && window.starknet_braavos) {
            ...
            try {
              ...
              console.warn('Could not detect Braavos wallet network, defaulting to testnet:', networkError);
            }
        ...
        case 'metamask':
          try {
            ...
            try {
              ...
              console.warn('Could not detect MetaMask network, defaulting to testnet:', networkError);
            }
          ...
          if (typeof window !== 'undefined' && (window as any).unisat) {
            try {
              ...
              try {
                ...
                console.warn('Could not detect Unisat network, defaulting to testnet:', networkError);
              }

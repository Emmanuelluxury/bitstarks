      ...
      <header>
        ...
        <nav>
          <ul>
            ...
            <li><a href="#"><i className="fas fa-history"></i> Transactions</a></li>
            <li><a href="#"><i className="fas fa-arrows-alt"></i> Swap</a></li>
            <li><a href="#"><i className="fas fa-unlock"></i> Lock-Unlock</a></li>
          </ul>
        </nav>
